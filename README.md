...
```
virtualenv --system-site-packages ~/venvs/talabatgram
```

6. Start the virtual environment
```
source ~/venvs/talabatgram/bin/activate
```
...
8. Copy this result and in your talabatgram/talabatgram/settings.py file replace
```
...
15. Now go to http://localhost:8000/ in your browser to view talabatgram
...
talabatgram is deployed on Heroku.
