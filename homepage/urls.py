...
urlpatterns = [
    path('', PostListView.as_view(), name='talabatgram-home'),
    path('about/us/', views.aboutUs, name='talabatgram-about-us'),
    path('about/jobs/', views.aboutJobs, name='talabatgram-about-jobs'),
    path('about/', views.redirectAboutView, name='talabatgram-about-us-redirect'),
    path('explore/', ExploreListView.as_view(), name='talabatgram-explore'),
